...
from django.forms.widgets import EmailInput, FileInput, HiddenInput, NumberInput, PasswordInput, TextInput,TextInput, Textarea
...
class PostForm(forms.ModelForm):
    class Meta:
        ...
        widgets = { "p_title": TextInput(attrs={"class": "form-control"}), "p_body":Textarea(attrs={"class": "form-control  body", }),
                   "p_head1": TextInput(attrs={"class": "form-control"}), "p_chead1":Textarea(attrs={"class": "form-control head1", }), "p_head2": TextInput(attrs={"class": "form-control"}), "p_chead2":Textarea(attrs={"class": "form-control head2", }), "p_thumbnail":FileInput(attrs={"class": "form-control", }),  }
